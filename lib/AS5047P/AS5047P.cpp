...
AS5047::AS5047(int CPR, float offset, int ppairs){
    //_CPR = CPR;
    _CPR = CPR;
    _ppairs = ppairs;
    ElecOffset = offset;
...
int AS5047::GetRawPosition(){
    return raw;
    }

int AS5047::GetSPIReadError(){
    return err;
}
 
float AS5047::GetMechPositionFixed(){
    return MechPosition+MechOffset;
    }
    
float AS5047::GetMechPosition(){
    return MechPosition;
    }
 
float AS5047::GetElecPosition(){
    return ElecPosition;
    }
 
float AS5047::GetElecVelocity(){
    return ElecVelocity;
    }
 
float AS5047::GetMechVelocity(){
    return MechVelocity;
    }
 
void AS5047::ZeroPosition(){
    rotations = 0;
    MechOffset = 0;
    Sample(.00025f);
...
void AS5047::SetElecOffset(float offset){
    ElecOffset = offset;
    }
void AS5047::SetMechOffset(float offset){
    MechOffset = offset;
    first_sample = 0;
    }
...
void AS5047::WriteLUT(int new_lut[128]){
